...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__21790){
var map__21791 = p__21790;
var map__21791__$1 = cljs.core.__destructure_map(map__21791);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21791__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__21799 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__21800 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__21800);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__21799);
}}));
} else {
...
(jsprops.onChange = (function (p1__21826_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__21826_SHARP_);
}));
