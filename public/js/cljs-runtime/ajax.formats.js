...
var G__13008 = request;
var G__13009 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__13008,G__13009) : ajax.formats.get_format.call(null,G__13008,G__13009));
} else {
...
return cljs.core.some((function (p1__13012_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__13012_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__13023){
var map__13024 = p__13023;
var map__13024__$1 = cljs.core.__destructure_map(map__13024);
var request = map__13024__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13024__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__13029 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__13029.cljs$core$IFn$_invoke$arity$1 ? fexpr__13029.cljs$core$IFn$_invoke$arity$1(response) : fexpr__13029.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__13032){
var map__13033 = p__13032;
var map__13033__$1 = cljs.core.__destructure_map(map__13033);
var request = map__13033__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13033__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__13031_SHARP_){
return ajax.formats.get_accept_entries(request,p1__13031_SHARP_);
