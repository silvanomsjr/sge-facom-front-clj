...
var i_13875 = (0);
while(true){
if((i_13875 < arr.length)){
(arr[i_13875] = null);

var G__13880 = (i_13875 + (1));
i_13875 = G__13880;
continue;
} else {
}
...
var i_13914 = (self__.level + (1));
while(true){
if((i_13914 <= (new_level + (1)))){
(update[i_13914] = self__.header);

var G__13916 = (i_13914 + (1));
i_13914 = G__13916;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13923 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13923[i]));
} else {
x__$2.forward.push((((i < links_13923.length))?(links_13923[i]):null));
}

if((i < links_13923.length)){
(links_13923[i] = x__$2);
} else {
links_13923.push(x__$2);
}
...
var links_13947 = (update[i_13946]).forward;
if((x__$1 === (((i_13946 < links_13947.length))?(links_13947[i_13946]):null))){
(links_13947[i_13946] = (x__$1.forward[i_13946]));

var G__13952 = (i_13946 + (1));
i_13946 = G__13952;
continue;
} else {
var G__13953 = (i_13946 + (1));
i_13946 = G__13953;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__13990 = nx;
var G__13991 = (level__$1 - (1));
x = G__13990;
level__$1 = G__13991;
continue;
} else {
var G__13995 = x;
var G__13996 = (level__$1 - (1));
x = G__13995;
level__$1 = G__13996;
continue;
}
