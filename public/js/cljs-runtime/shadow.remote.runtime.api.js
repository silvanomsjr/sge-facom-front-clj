...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13590 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13590(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13598 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13598(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13599 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13599(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13602 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13602(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13614 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13614(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13624 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13624(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13576,callback){
var map__13577 = p__13576;
var map__13577__$1 = cljs.core.__destructure_map(map__13577);
var input = map__13577__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13577__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13577__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
