...
var errors = (function (){var G__12811 = cljs.core.PersistentVector.EMPTY;
var G__12811__$1 = ((clojure.string.blank_QMARK_(cljs.core.deref(main.pages.login.view.usuario)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__12811,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"usuario","usuario",-1332303918)], null)):G__12811);
if(clojure.string.blank_QMARK_(cljs.core.deref(main.pages.login.view.senha))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__12811__$1,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"senha","senha",1788313207)], null));
} else {
return G__12811__$1;
}
})();
...
return main.pages.login.view.req_to_api((function (p__12812){
var map__12813 = p__12812;
var map__12813__$1 = cljs.core.__destructure_map(map__12813);
var token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12813__$1,new cljs.core.Keyword(null,"token","token",-1211463215));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full h-screen flex justify-center items-center"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-[40%] p-8 flex flex-col shadow-2xl rounded-sm border-gray-200 border-1 gap-2"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [main.pages.login.view.logo], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Usu\u00E1rio",new cljs.core.Keyword(null,"class","class",-2030961996),"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline",new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__12814_SHARP_){
return cljs.core.reset_BANG_(main.pages.login.view.usuario,p1__12814_SHARP_.target.value);
}),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(main.pages.login.view.usuario),new cljs.core.Keyword(null,"required","required",1807647006),true], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Senha",new cljs.core.Keyword(null,"class","class",-2030961996),"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline",new cljs.core.Keyword(null,"type","type",1174270348),"password",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(main.pages.login.view.senha),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__12815_SHARP_){
return cljs.core.reset_BANG_(main.pages.login.view.senha,p1__12815_SHARP_.target.value);
