...
var G__22172 = o;
reagent.impl.template.goog$module$goog$object.set(G__22172,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22356__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22356 = function (var_args){
var args = null;
...
return G__22356__delegate.call(this,args);};
G__22356.cljs$lang$maxFixedArity = 0;
G__22356.cljs$lang$applyTo = (function (arglist__22359){
var args = cljs.core.seq(arglist__22359);
return G__22356__delegate(args);
});
...
var G__22181 = o;
reagent.impl.template.goog$module$goog$object.set(G__22181,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22193 = props;
var G__22193__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22193,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22193);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22193__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22195 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22195,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22195;
}
})(),id_class);
...
var temp__5804__auto___22375 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___22375)){
var d_22376 = temp__5804__auto___22375;
if((d_22376 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22376.s}));
} else {
...
var G__22197 = (cljs.core.count(argv) - first_child);
switch (G__22197) {
case (0):
...
var vec__22203 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22203,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22203,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22203,(2),null);
...
var temp__5808__auto___22383 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22383 == null)){
} else {
var key_22385 = temp__5808__auto___22383;
(jsprops.key = key_22385);
}
...
var temp__5808__auto___22390 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22390 == null)){
} else {
var key_22391 = temp__5808__auto___22390;
(jsprops.key = key_22391);
}
...
var temp__5808__auto___22396 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22396 == null)){
} else {
var key_22397 = temp__5808__auto___22396;
(jsprops.key = key_22397);
}
...
var temp__5808__auto___22404 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22404 == null)){
} else {
var key_22405 = temp__5808__auto___22404;
(jsprops.key = key_22405);
}
...
var temp__5808__auto___22406 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22406 == null)){
} else {
var key_22408 = temp__5808__auto___22406;
(jsprops.key = key_22408);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22236_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22236_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22251 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22251,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22251,(1),null);
...
break;
default:
var G__22414 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22415 = compiler;
v = G__22414;
compiler = G__22415;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22322 = (function (opts,id,fn_to_element,parse_fn,meta22323){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22322.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22324,meta22323__$1){
var self__ = this;
var _22324__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22322(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22323__$1));
}));

(reagent.impl.template.t_reagent$impl$template22322.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22324){
var self__ = this;
var _22324__$1 = this;
return self__.meta22323;
}));

(reagent.impl.template.t_reagent$impl$template22322.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22322.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22322.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22322.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22322.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22322.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22323","meta22323",1797929113,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22322.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22322.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22322");

(reagent.impl.template.t_reagent$impl$template22322.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22322");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22322.
 */
reagent.impl.template.__GT_t_reagent$impl$template22322 = (function reagent$impl$template$__GT_t_reagent$impl$template22322(opts,id,fn_to_element,parse_fn,meta22323){
return (new reagent.impl.template.t_reagent$impl$template22322(opts,id,fn_to_element,parse_fn,meta22323));
});
...
return (new reagent.impl.template.t_reagent$impl$template22322(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
